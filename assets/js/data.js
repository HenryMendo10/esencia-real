export const aretes = [
    {
        ...
        imagen2: "assets/img/aretes/1.arete-aura/2.png",
        imagen3: "assets/img/aretes/1.arete-aura/3.png",
        imagen4: "assets/img/aretes/1.arete-aura/4.png",
        imagen5: "assets/img/aretes/1.arete-aura/5.png",
        oro: true,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
        ...
        "descripcion1": "Con una aguja de acero inoxidable y un elegante chapado en oro de 18 quilates, este producto combina durabilidad y estilo. La aleación de zinc aporta ligereza y resistencia, lo que lo hace perfecto para un uso prolongado y libre de preocupaciones. Ideal para pieles sensibles gracias a sus propiedades hipoalergénicas.",
        "descripcion2": "Medidas aproximadas: 1.8 cm de largo y 1 cm de ancho. El tamaño compacto y cómodo lo convierte en una opción ideal para quienes buscan elegancia y comodidad en un solo accesorio."
    },
    {
        nombre: "Arete Nara",
        precio: "S/.18.00",
        imagen: "assets/img/aretes/2.arete-nara/1.png",
        imagen2: "assets/img/aretes/2.arete-nara/2.png",
        imagen3: "assets/img/aretes/2.arete-nara/3.png",
        imagen4: "assets/img/aretes/2.arete-nara/4.png",
        oro: true,
        plata: true,
        "caracteristicas": [
            "Sin enchapado",
...
},
    {
        ...
        "descripcion2": "2 cm de largo y 0.5 cm de grosor.."
    },
    {
        nombre: "Arete Siara",
        precio: "S/.18.00",
    ...
    },
    {
        ...
        imagen4: "assets/img/aretes/argolla-alba/4.png",
        oro: true,
        plata: false,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    },
    {
        ...
        imagen4: "assets/img/aretes/argolla-mara/4.png",
        oro: true,
        plata: false,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    {
        nombre: "Arete Adriana",
        precio: "S/.17.00",
        imagen: "assets/img/aretes/arete-adriana/1.png",
        imagen2: "assets/img/aretes/arete-adriana/2.png",
        imagen3: "assets/img/aretes/arete-adriana/3.png",
        oro: true,
        plata: false,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    {
        nombre: "Arete Alessia",
        precio: "S/.6.00 - S/.9.00",
        imagen: "assets/img/aretes/arete-alessia/1.png",
        imagen2: "assets/img/aretes/arete-alessia/2.png",
        imagen3: "assets/img/aretes/arete-alessia/3.png",
        imagen4: "assets/img/aretes/arete-alessia/4.png",
        imagen5: "assets/img/aretes/arete-alessia/5.png",
        oro: true,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
...

    {
        nombre: "Aretes Nerea",
        precio: "S/.15.00",
        imagen: "assets/img/aretes/arete-nerea/1.png",
        imagen2: "assets/img/aretes/arete-nerea/2.png",
        imagen3: "assets/img/aretes/arete-nerea/3.png",
        imagen4: "assets/img/aretes/arete-nerea/4.png",
        oro: false,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    },
    {
        nombre: "Arete Briana",
        precio: "S/.17.00",
        imagen: "assets/img/aretes/arete-briana/1.png",
        imagen2: "assets/img/aretes/arete-briana/2.png",
        oro: true,
        plata: false,
        "caracteristicas": [
            "Acero inoxidable",
...
export const collares = [
    {
        nombre: "Collar Serpiente",
        precio: "S/.20.00",
        imagen: "assets/img/collares/collar-serpiente/1.png",
        imagen2: "assets/img/collares/collar-serpiente/2.png",
        imagen3: "assets/img/collares/collar-serpiente/3.png",
        imagen4: "assets/img/collares/collar-serpiente/4.png",
        imagen5: "assets/img/collares/collar-serpiente/5.png",
        oro: true,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    },
    {
        nombre: "Collar Ibiza",
        precio: "S/.18.00",
        imagen: "assets/img/collares/collar-ibiza/1.png",
        imagen2: "assets/img/collares/collar-ibiza/2.png",
        imagen3: "assets/img/collares/collar-ibiza/3.png",
        imagen4: "assets/img/collares/collar-ibiza/4.png",
        imagen5: "assets/img/collares/collar-ibiza/5.png",
        oro: true,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    },
    {
        nombre: "Collar Maria",
        precio: "S/.19.00",
        imagen: "assets/img/collares/collar-maria/1.png",
        imagen2: "assets/img/collares/collar-maria/2.png",
        imagen3: "assets/img/collares/collar-maria/3.png",
        oro: true,
        plata: false,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    },
    {
        nombre: "Cadena Prada",
        precio: "S/.14.00",
        imagen: "assets/img/collares/collar-prada/1.png",
        imagen2: "assets/img/collares/collar-prada/2.png",
        oro: false,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    {
        nombre: "Collar Fernanda",
        precio: "S/.18.00",
        imagen: "assets/img/collares/collar-fernanda/1.png",
        imagen2: "assets/img/collares/collar-fernanda/2.png",
        imagen3: "assets/img/collares/collar-fernanda/3.png",
        imagen4: "assets/img/collares/collar-fernanda/4.png",
        oro: true,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    {
        nombre: "Collar Antonella",
        precio: "S/.17.00",
        imagen: "assets/img/collares/collar-cayetana/1.png",
        imagen2: "assets/img/collares/collar-cayetana/2.png",
        oro: true,
        plata: false,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    {
        nombre: "Collar Priscila",
        precio: "S/.17.00",
        imagen: "assets/img/collares/collar-perla/1.png",
        imagen2: "assets/img/collares/collar-perla/2.png",
        oro: false,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    },
    {
        nombre: "Collar Gota",
        precio: "S/.18.00",
        imagen: "assets/img/collares/collar-gota/1.png",
        imagen2: "assets/img/collares/collar-gota/2.png",
        imagen3: "assets/img/collares/collar-gota/3.png",
    ...
    {
        nombre: "Collar Alondra",
        precio: "S/.22.00",
        imagen: "assets/img/collares/collar-trebol/1.png",
        imagen2: "assets/img/collares/collar-trebol/2.png",
        imagen3: "assets/img/collares/collar-trebol/3.png",
        oro: true,
        plata: false,
        "caracteristicas": [
            "Acero inoxidable",
...
export const pulseras = [
    {
        nombre: "PULSERA ALONDRA",
        precio: "S/.22.00",
        imagen: "assets/img/pulseras/trebol-blanco/1.png",
    ...
    },
    {
        ...
        imagen2: "assets/img/pulseras/1CAYETANA/2.png",
        imagen3: "assets/img/pulseras/1CAYETANA/3.png",
        imagen4: "assets/img/pulseras/1CAYETANA/4.png",
        imagen5: "assets/img/pulseras/1CAYETANA/5.png",
        oro: true,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    {
        nombre: "Pulsera Serpiente",
        precio: "S/.18.00",
        imagen: "assets/img/pulseras/2SERPIENTE/1.png",
        imagen2: "assets/img/pulseras/2SERPIENTE/2.png",
        imagen3: "assets/img/pulseras/2SERPIENTE/3.png",
        imagen4: "assets/img/pulseras/2SERPIENTE/4.png",
        imagen5: "assets/img/pulseras/2SERPIENTE/5.png",
        oro: true,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    {
        nombre: "Pulsera Alina",
        precio: "S/.16.00",
        imagen: "assets/img/pulseras/3ALINA/1.png",
        imagen2: "assets/img/pulseras/3ALINA/2.png",
        imagen3: "assets/img/pulseras/3ALINA/3.png",
        imagen4: "assets/img/pulseras/3ALINA/4.png",
        imagen5: "assets/img/pulseras/3ALINA/5.png",
        oro: true,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    {
        nombre: "Pulsera Amara",
        precio: "S/.18.00",
        imagen: "assets/img/pulseras/4AMARA/1.png",
        imagen2: "assets/img/pulseras/4AMARA/2.png",
        imagen3: "assets/img/pulseras/4AMARA/3.png",
        imagen4: "assets/img/pulseras/4AMARA/4.png",
        imagen5: "assets/img/pulseras/4AMARA/5.png",
        oro: true,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    {
        nombre: "Pulsera Catalina",
        precio: "S/.16.00",
        imagen: "assets/img/pulseras/5CATALINA/1.png",
        imagen2: "assets/img/pulseras/5CATALINA/2.png",
        imagen3: "assets/img/pulseras/5CATALINA/3.png",
        imagen4: "assets/img/pulseras/5CATALINA/4.png",
        imagen5: "assets/img/pulseras/5CATALINA/5.png",
        oro: true,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    {
        nombre: "Pulsera Vanessa",
        precio: "S/.16.00",
        imagen: "assets/img/pulseras/6VANESSA/1.png",
        imagen2: "assets/img/pulseras/6VANESSA/2.png",
        imagen3: "assets/img/pulseras/6VANESSA/3.png",
        imagen4: "assets/img/pulseras/6VANESSA/4.png",
        imagen5: "assets/img/pulseras/6VANESSA/5.png",
        oro: true,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    {
        nombre: "Pulsera Ibiza",
        precio: "S/.17.00",
        imagen: "assets/img/pulseras/7IBIZA/1.png",
        imagen2: "assets/img/pulseras/7IBIZA/2.png",
        imagen3: "assets/img/pulseras/7IBIZA/3.png",
        imagen4: "assets/img/pulseras/7IBIZA/4.png",
        imagen5: "assets/img/pulseras/7IBIZA/5.png",
        oro: true,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    {
        nombre: "Pulsera Venecia",
        precio: "S/.17.00",
        imagen: "assets/img/pulseras/8VENECIA/1.png",
        imagen2: "assets/img/pulseras/8VENECIA/2.png",
        imagen3: "assets/img/pulseras/8VENECIA/3.png",
        imagen4: "assets/img/pulseras/8VENECIA/4.png",
        imagen5: "assets/img/pulseras/8VENECIA/5.png",
        oro: true,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    },
    {
        nombre: "Pulsera Naia",
        precio: "S/.17.00",
        imagen: "assets/img/pulseras/9NAIA/1.png",
        imagen2: "assets/img/pulseras/9NAIA/2.png",
        imagen3: "assets/img/pulseras/9NAIA/3.png",
        imagen4: "assets/img/pulseras/9NAIA/4.png",
        imagen5: "assets/img/pulseras/9NAIA/5.png",
        oro: true,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    {
        nombre: "Pulsera Ivana",
        precio: "S/.16.00",
        imagen: "assets/img/pulseras/10IVANA/1.png",
        imagen2: "assets/img/pulseras/10IVANA/2.png",
        imagen3: "assets/img/pulseras/10IVANA/3.png",
        imagen4: "assets/img/pulseras/10IVANA/4.png",
        imagen5: "assets/img/pulseras/10IVANA/5.png",
        oro: true,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    {
        nombre: "Pulsera Isadora",
        precio: "S/.17.00",
        imagen: "assets/img/pulseras/11ISADORA/1.png",
        imagen2: "assets/img/pulseras/11ISADORA/2.png",
        imagen3: "assets/img/pulseras/11ISADORA/3.png",
        imagen4: "assets/img/pulseras/11ISADORA/4.png",
        imagen5: "assets/img/pulseras/11ISADORA/5.png",
        oro: true,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    {
        nombre: "Pulsera Bianca",
        precio: "S/.16.00",
        imagen: "assets/img/pulseras/12BIANCA/1.png",
        imagen2: "assets/img/pulseras/12BIANCA/2.png",
        imagen3: "assets/img/pulseras/12BIANCA/3.png",
        imagen4: "assets/img/pulseras/12BIANCA/4.png",
        imagen5: "assets/img/pulseras/12BIANCA/5.png",
        oro: true,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
...
export const coleccion = [
    ...
    {
        nombre: "Set Serpiente / Dorado",
        precio: "S/.35.00",
        imagen: "assets/img/set/set-serpiente-dorado/1.png",
        imagen2: "assets/img/pulseras/2serpiente/2.png",
        imagen3: "assets/img/pulseras/2serpiente/3.png",
        imagen4: "assets/img/collares/collar-serpiente/2.png",
        oro: true,
        plata: false,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    {
        nombre: "Set Serpiente / Plata",
        precio: "S/.35.00",
        imagen: "assets/img/set/set-serpiente-plata/5.png",
        imagen2: "assets/img/pulseras/2serpiente/4.png",
        imagen3: "assets/img/pulseras/2serpiente/5.png",
        imagen4: "assets/img/collares/collar-serpiente/4.png",
        oro: false,
        plata: true,
        "caracteristicas": [
    ...
    {
        nombre: "Set Ibiza / Dorado",
        precio: "S/.32.00",
        imagen: "assets/img/set/set-ibiza-dorado/2.png",
        imagen2: "assets/img/pulseras/7IBIZA/2.png",
        imagen3: "assets/img/collares/collar-ibiza/2.png",
        imagen4: "assets/img/collares/collar-ibiza/3.png",
    ...
    {
        nombre: "Set Ibiza / Plata",
        precio: "S/.32.00",
        imagen: "assets/img/set/set-ibiza-plata/3.png",
        imagen2: "assets/img/pulseras/7IBIZA/4.png",
        imagen3: "assets/img/collares/collar-ibiza/4.png",
        imagen4: "assets/img/collares/collar-ibiza/5.png",
        oro: false,
        plata: true,
        "caracteristicas": [
            "Acero inoxidable",
    ...
    },
    {
        ...
        imagen2: "assets/img/pulseras/trebol-blanco/2.png",
        imagen3: "assets/img/collares/collar-trebol/1.png",
        oro: true,
        plata: false,
        "caracteristicas": [
            "Acero inoxidable",
